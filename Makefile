...
test: test-server
	...
	$(PY) scripts/test_zoning.py
	$(PY) scripts/test_roadplan.py
	$(PY) scripts/test_osmgeom.py
	$(PY) scripts/test_access.py
	$(PY) scripts/test_deploy_size.py
	...
	node scripts/test_track.js
	node scripts/test_brand.js
	node scripts/test_links.js
	node scripts/test_qr.js

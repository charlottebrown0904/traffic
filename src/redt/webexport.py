...
LANDPRICE_GROUPS = [
    ...
    ("준주거", "준주거", "junju"),
    ("전용주거(미세분)", "전용주거", "jeonyong"),
    ("일반주거(미세분)", "일반주거", "ilbanju"),
    # ── 도시지역 · 상업 ──
    ("중심상업", "중심상업", "jungsang"),
    ("일반상업", "일반상업", "ilbansang"),
    ("근린상업", "근린상업", "geunrin"),
...
# 화면에서 묶어 보여줄 갈래. 한 목록에 스물넷을 평평하게 늘어놓으면
# 부천의 자연녹지와 안성의 계획관리를 같은 종류로 나란히 놓게 된다.
LANDPRICE_ZONE_KIND = {
    "계획관리": "비도시지역", "생산관리": "비도시지역",
    "보전관리": "비도시지역", "농림": "비도시지역",
    "자연환경보전": "비도시지역", "관리(미세분)": "비도시지역",

    "자연녹지": "도시지역", "생산녹지": "도시지역", "보전녹지": "도시지역",
    "제1종전용주거": "도시지역", "제2종전용주거": "도시지역",
    "제1종일반주거": "도시지역", "제2종일반주거": "도시지역",
    "제3종일반주거": "도시지역", "준주거": "도시지역",
    "전용주거(미세분)": "도시지역", "일반주거(미세분)": "도시지역",
    "중심상업": "도시지역", "일반상업": "도시지역",
    "근린상업": "도시지역", "유통상업": "도시지역",
    "전용공업": "도시지역", "일반공업": "도시지역", "준공업": "도시지역",

...
# ── 2단계 지오코딩 ────────────────────────────────────────────────────
#
# 좌표 없는 거래가 329만 건인데 브이월드 하루 한도는 3만~4만 건입니다.
# 그대로면 100번 가까이 실행해야 합니다.
# **전국을 다 붙일 필요가 없다는 것이 답입니다.**
#
# (여기 '4,000건' 이라고 적혀 있었다. 근거 없이 박아둔 숫자였고
#  collect.yml 이 이미 그것을 바로잡아 뒀는데 이 줄만 남아 있었다.
#  두 곳이 다른 숫자를 말하면 나중에 읽는 사람이 낮은 쪽을 믿는다.)
#

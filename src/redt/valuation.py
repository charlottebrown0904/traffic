...
#
# 2026-09-15 전국 실측 (최근 24개월 · 5천만원 이상 · 1,302건 산출):
#   결정(현행)  중앙 1.24 · ±30% 안 352 · 2배 안 678
#   선례2배     중앙 1.25 · ±30% 안 353 · 2배 안 693
#   선례3배     중앙 1.25 · ±30% 안 363 · 2배 안 685
#   선례3배√    중앙 1.23 · ±30% 안 368 · 2배 안 686   ← 이긴다
#   평가선례만  중앙 1.18 · ±30% 안 349 · 2배 안 642
#   거래사례만  중앙 1.21 · ±30% 안 340 · 2배 안 651
# 선례3배√ 가 중앙도 1.00 에 더 가깝고 ±30% 도 가장 많다. 9-13 측정에서는
# 거래사례 쪽이 이겼는데 뒤집힌 까닭은 원장이 커졌기 때문이다 (평가서 443건).
OTHER_WEIGHT = "선례3배√"
...
# 전국 계획관리 254건 실측(2026-09-13, run 34751009085): 위아래 다 열어
# (0.5~2.0) 두었더니 ±30% 적중이 80 → 75 로 **줄었다**. 값이 바뀐 183건 중
# 위로 올린 쪽이 산출을 더 높게 만들었다 — 전국 중앙이 0.91(끈 채)로 이미
# 산출이 높은 쪽이라, 개별공시지가가 표준지보다 높다고 산출을 더 올리는
# 것은 방향이 틀렸다. 그래서 **내리는 쪽만** 쓴다 (상한 1.0): 같은 지목군

...
> ## ⚠️ 아래 「0. 전환 전 확인」 표는 **2026-08-29 시점**입니다
>
> 그 **다음날(8/30) 커밋 `25292d8` 에 `DATA_GO_KR_KEY` 가 들어갔습니다.**
> 그래서 "키를 재발급할 필요가 없습니다" 는 지금은 사실이 아닙니다.
>
> 검사 결과를 문서에 적어두면 그 순간에는 맞지만, 시간이 지나면
> **틀린 채로 신뢰받습니다.** 지우지 않고 시점을 밝혀 남깁니다.
>
> 지금 기준 감사와 공개/비공개 전환 절차는 **`docs/going-public.md`**,
> 매번 자동으로 다시 확인하는 것은 `scripts/test_privacy.py` 입니다.

## 0. 전환 전 확인 — 이미 끝난 것 (2026-08-29 시점)

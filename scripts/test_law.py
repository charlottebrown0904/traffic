...
rows = [{"자치법규명": "안성시 도시계획 조례", "지자체기관명": "경기도 안성시", "자치법규일련번호": "1", "시행일자": "20240101"},
        ...
        {"자치법규명": "전라남도 도시계획 조례", "지자체기관명": "구 전라남도", "자치법규일련번호": "7", "시행일자": "20250101"},
        {"자치법규명": "여수시 도시계획 조례", "지자체기관명": "전라남도 여수시", "자치법규일련번호": "8", "시행일자": "20250101",
         "제개정구분명": "폐지"}]
w = L.wanted(rows)
check([r["_mst"] for r in w] == ["2", "4", "6"], f"안성 최신(2) · 양평 군계획 · 세종 도시·군계획 · 옛 기관·폐지 제외 — {[r['_mst'] for r in w]}")

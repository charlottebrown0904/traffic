...
요구사항(2026-09-09): "전국구로 확대해 주시고 제가 파일을 받는 것이
빠르면 그렇게 해주세요."
...
셋 다 안 되면 code.go.kr 에서 파일을 직접 받는 것이
...
def probe_stan_regin() -> None:
    ...
    #
    # **아랫줄은 등록 여부를 부정하지 않습니다.** 제가 오퍼레이션
...
def main() -> int:
  ...
  셋 다 안 서면 code.go.kr 에서 '법정동코드 전체자료' 를

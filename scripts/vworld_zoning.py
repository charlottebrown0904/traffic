...
#
# 처음에 y 를 3494 로 잘못 적었다. 그 타일은 향남이 아니라 훨씬 남쪽이다.
# 검사(scripts/test_tile.js 9절)가 '점이 타일 안에 있나' 를 숫자로 보다가
# 잡았다 — 그림은 오는데 땅이 어긋나는 종류라 눈으로는 못 잡는다.
TILE = {"z": 13, "x": 6983, "y": 3186}
